...
var dahliaGraphqlClient = require('dahlia-graphql-client');
...
function config(options) {
    exports.graphqlConfig = __assign({}, exports.graphqlConfig, options);
}
...
var query = function (input, variables) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                endpoint = exports.graphqlConfig.endpoint;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, dahliaGraphqlClient.query(endpoint, input, variables)];
            case 2:
                data = _a.sent();
...
var useQuery = function (input, variables) {
    var initialState = {};
    var _a = react.useState(initialState), result = _a[0], setState = _a[1];
    var unmounted = false;
